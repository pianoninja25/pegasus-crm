  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "glass-strong rounded-[var(--radius)] shadow-glow border-gradient",
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 rounded-md p-1 text-muted-foreground opacity-70 transition-all hover:bg-foreground/10 hover:text-foreground hover:opacity-100 focus:outline-none">
        <X className="h-4 w-4" />
